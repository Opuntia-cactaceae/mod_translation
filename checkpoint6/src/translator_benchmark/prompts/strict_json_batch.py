...
#тот же батч но в профиль (требования к тексту жестче)
class StrictJsonBatchPromptProfile:
...
def build_strict_json_batch_profile(config: PromptConfig) -> StrictJsonBatchPromptProfile:
    """
    Args:
        config: Prompt configuration.

    Returns:
        StrictJsonBatchPromptProfile instance.
    """
    return StrictJsonBatchPromptProfile(config)